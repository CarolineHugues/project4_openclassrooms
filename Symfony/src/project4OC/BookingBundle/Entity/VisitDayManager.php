...
class VisitDayManager
{
	...
	public function available($date, $gauge)
	{
		...
		if ($date < date('d/m/Y') OR $gauge == 1000 OR $selectedDate[0] == /*"dimanche/mardi !??"*/ OR ($selectedDate[0] == 1 AND $selectedDate[1] == 05) OR ($selectedDate[0] == 1 AND $selectedDate[1] ==  11) OR ($selectedDate[0] == 25 AND $selectedDate[0] == 12) OR $currentDate[1] > 18)
		{
